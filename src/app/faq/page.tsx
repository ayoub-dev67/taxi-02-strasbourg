    ...
    questions: [
      {
        ...
        answer:
          "Vous pouvez réserver par téléphone au 07 53 14 53 71, via WhatsApp, ou directement sur notre site web via le formulaire de réservation. Nous vous confirmons rapidement votre course.",
      },
      {
