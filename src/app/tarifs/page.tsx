      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="card-premium text-center">
            <p className="text-gray-600 mb-2">Prise en charge</p>
            <p className="text-3xl font-bold text-gold-400">
              {TARIFS_PREFECTURE_67.priseEnCharge.toFixed(2)} &euro;
            </p>
          </div>
          <div className="card-premium text-center">
            <p className="text-gray-600 mb-2">Minimum de course</p>
            <p className="text-3xl font-bold text-gold-400">
              {TARIFS_PREFECTURE_67.minimumCourse.toFixed(2)} &euro;
            </p>
          </div>
          <div className="card-premium text-center">
            <p className="text-gray-600 mb-2">Heure d&apos;attente</p>
            <p className="text-3xl font-bold text-gold-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="card-premium">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground">Tarif Jour</h3>
                  <p className="text-gray-600 text-sm">7h - 19h (lun-sam)</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-surface-100 rounded-lg">
                  <div>
                    <p className="text-foreground font-medium">Tarif A</p>
                ...
                <div className="flex justify-between items-center p-3 bg-surface-100 rounded-lg">
                  <div>
                    <p className="text-foreground font-medium">Tarif C</p>
            ...
            <div className="card-premium">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-foreground">Tarif Nuit</h3>
                  <p className="text-gray-600 text-sm">19h - 7h, dim, fériés</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-surface-100 rounded-lg">
                  <div>
                    <p className="text-foreground font-medium">Tarif B</p>
                    <p className="text-gray-500 text-sm">Retour en charge</p>
                  </div>
                  <p className="text-gold-400 font-bold text-xl">
                ...
                <div className="flex justify-between items-center p-3 bg-surface-100 rounded-lg">
                  <div>
                    <p className="text-foreground font-medium">Tarif D</p>
                    <p className="text-gray-500 text-sm">Retour à vide</p>
                  </div>
                  <p className="text-gold-400 font-bold text-xl">
          ...
          <div className="card-premium">
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 border-b border-gold-400/10">
                <div>
                  <p className="text-foreground font-medium">Passager supplémentaire</p>
              ...
              <div className="flex justify-between items-center p-3 border-b border-gold-400/10">
                <div>
                  <p className="text-foreground font-medium">Bagage volumineux</p>
              ...
              <div className="flex justify-between items-center p-3">
                <div>
                  <p className="text-foreground font-medium">Animal</p>
        ...
        <div className="card-premium bg-gold-400/5 border-gold-400/30">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-foreground font-semibold mb-2">Information</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 mb-3">
                  Tous nos tarifs sont affichés dans le véhicule et calculés au compteur homologué par la Préfecture.
                </p>
                <p className="text-gray-600">
                  Aucune surprise, aucun frais caché. Vous payez uniquement ce qui est indiqué au compteur, conformément aux tarifs préfectoraux en vigueur.
                </p>
              </div>
            </div>
          </div>
