...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Pages établissements de santé (SEO fort - transport médical)
  const etablissementPages: MetadataRoute.Sitemap = etablissementsSante.map(
    (etablissement) => ({
      url: `${baseUrl}/services/transport-medical/${etablissement.slug}`,
      lastModified: currentDate,
      changeFrequency: "monthly" as const,
      priority: 0.8, // Priorité élevée car fort potentiel SEO
    })
  );
