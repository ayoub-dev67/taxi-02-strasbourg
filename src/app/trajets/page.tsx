            ...
            >
              <div className="flex items-start justify-between gap-4 mb-4">
                <div className="flex-1">
                  <h2 className="text-lg font-semibold text-foreground mb-1 group-hover:text-gold-400 transition-colors">
                    {trajet.to}
                  </h2>
              ...
              <div className="flex flex-wrap gap-4 mb-4">
                <div className="flex items-center gap-1.5 text-sm">
                  ...
                  <span className="text-gray-700">{trajet.distance} km</span>
                </div>
                <div className="flex items-center gap-1.5 text-sm">
                  <Clock className="w-4 h-4 text-gold-400" />
                  <span className="text-gray-700">{trajet.duration}</span>
                </div>
                <div className="flex items-center gap-1.5 text-sm">
