      ...
      <div className="text-center max-w-lg">
        ...
        <div className="relative mb-8">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-24 h-24 rounded-full bg-gold-400/8 border border-gold-400/30 flex items-center justify-center">
        ...
        <div className="card-premium inline-block">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-gold-400/8 border border-gold-400/20 flex items-center justify-center">
