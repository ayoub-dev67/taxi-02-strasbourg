      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-lg">
            Taxi 02 Strasbourg est agréé par la Caisse Primaire d&apos;Assurance Maladie pour
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative h-64 sm:h-80 md:h-96 rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <p className="text-white/90 text-sm">
                  Véhicule agréé pour le transport sanitaire — Prise en charge Sécurité Sociale
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-16">
          <div className="card-premium max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-4">
              En tant que taxi conventionné, Taxi 02 Strasbourg facture directement la
              CPAM. Vous n&apos;avez donc pas à avancer les frais (sauf participation
              forfaitaire éventuelle).
            </p>
            <p className="text-gray-600">
              Notre véhicule dispose d&apos;un <strong>grand coffre</strong> adapté au transport
              de fauteuils roulants pliants, déambulateurs et équipements médicaux.
              Idéal pour les personnes à mobilité réduite. Toutes distances assurées.
            </p>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {eligibleTransports.map((item, index) => (
              <div
                key={index}
                className="flex items-center gap-3 p-4 rounded-lg border border-gold-400/20 bg-surface-100"
              >
