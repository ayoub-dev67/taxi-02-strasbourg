...
const services = [
  ...
  {
    icon: Globe,
    title: "Transfert Europa-Park",
    description:
      "Transfert direct Strasbourg — Europa-Park en 45 min. Véhicule grand coffre idéal pour les familles. Aller-retour possible.",
    href: "/services/transfert-europapark",
    features: [
      "Europa-Park & Rulantica",
      "45 min porte à porte",
      "Grand coffre familles",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-lg">
            Du transport médical aux transferts aéroport, Taxi 02 Strasbourg vous propose
            ...
            <Link key={service.href} href={service.href} className="block group">
              <div className="card-premium h-full">
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    {service.badge && (
                      <span className="inline-block text-xs bg-gold-50 text-gold-400 font-semibold px-2.5 py-0.5 rounded-full border border-gold-400/20 mb-1.5">
                        {service.badge}
                      </span>
                    )}
                    <h2 className="text-xl font-semibold text-foreground group-hover:text-gold-400 transition-colors">
                      {service.title}
                    </h2>
