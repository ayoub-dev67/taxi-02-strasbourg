...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Oui, vous êtes libre de choisir le taxi conventionné de votre choix. Taxi 02 Strasbourg est conventionné par la CPAM du Bas-Rhin et assure tous les transports médicaux dans la région de Strasbourg.",
  },
  {
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-14">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-white mb-6">
              Transport Médical <span className="text-gold-400">VSL</span>
            </h1>
        ...
        <section className="mb-16">
          <div className="card-premium max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mb-4">
              Le <strong className="text-foreground">VSL (Véhicule Sanitaire Léger)</strong> est
            ...
            <p className="text-gray-600 mb-4">
              En tant que taxi conventionné, Taxi 02 Strasbourg est agréé par la Caisse Primaire
        ...
        <section className="mb-16">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Transport conventionné CPAM vers tous les hôpitaux et cliniques de Strasbourg et environs.
              Cliquez sur un établissement pour plus d'informations.
            </p>
            <div className="divider-gold" />
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {etablissementsSante.map((etablissement) => (
              <Link
                key={etablissement.slug}
                href={`/services/transport-medical/${etablissement.slug}`}
                className="card-premium group hover:border-gold-400/50 transition-all overflow-hidden p-0"
              >
                {etablissement.image && (
                  <div className="relative h-40 w-full overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="inline-flex items-center gap-1 text-xs bg-white/90 backdrop-blur-sm text-gold-400 font-semibold px-2.5 py-1 rounded-full border border-gold-400/20">
                ...
                <div className="p-5">
                  <h3 className="text-base font-semibold text-foreground mb-1 group-hover:text-gold-400 transition-colors">
                    {etablissement.shortName}
                  </h3>
                  <p className="text-gray-600 text-xs mb-1">{etablissement.city}</p>
                  <div className="flex items-center gap-1 text-xs text-gray-500 mb-3">
                    <Clock className="w-3 h-3" />
                    <span>{etablissement.distanceFromStrasbourg.duration} depuis Strasbourg</span>
                  </div>
                  <p className="text-gray-600 text-sm line-clamp-2 mb-3">
                    {etablissement.description.substring(0, 120)}...
                  </p>
                  <div className="flex items-center text-gold-400 text-sm font-medium group-hover:underline">
                    En savoir plus
