  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
        <div className="absolute inset-0 bg-gradient-to-br from-gold-50 to-transparent rounded-2xl" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3/4 h-1/2 bg-gold-50/50 blur-2xl" />
      </div>
      ...
      {/* Icon with rotation */}
      <motion.div
        className="w-14 h-14 rounded-xl bg-gold-50 flex items-center justify-center mx-auto mb-4 relative z-10"
      ...
      {/* Content */}
      <h3 className="text-lg font-semibold text-foreground mb-2 relative z-10 group-hover:text-gold-400 transition-colors duration-300">
        {title}
      </h3>
...
export function TestimonialCard({
  ...
  return (
    ...
    >
      {/* Glow */}
      <div className="absolute -top-10 -right-10 w-32 h-32 bg-gold-50 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      ...
      {/* Comment */}
      <p className="text-gray-700 text-sm mb-4 relative z-10">&ldquo;{comment}&rdquo;</p>
