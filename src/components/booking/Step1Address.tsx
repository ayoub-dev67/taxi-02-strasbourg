...
import { AddressAutocompleteOSM } from "@/components/maps/AddressAutocompleteOSM";
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <button
              ...
              className="px-3 py-1.5 text-sm bg-surface-100 text-gray-700 rounded-full border border-gold-400/20 hover:border-gold-400/50 hover:text-gold-400 transition-all"
            >
              {destination.label}
            </button>
          ))}
