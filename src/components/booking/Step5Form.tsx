...
export function Step5Form({ data, updateData, onSubmit, onPrev, isLoading }: Step5FormProps) {
  ...
  const validateForm = (): boolean => {
    ...
    if (data.client?.email?.trim() && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(data.client.email)) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="nom" className="text-foreground flex items-center gap-2">
        ...
        {/* Prénom */}
        <div className="space-y-2">
          <Label htmlFor="prenom" className="text-foreground flex items-center gap-2">
            <User className="w-4 h-4 text-gold-400" />
            Prénom
          </Label>
          <Input
      ...
      {/* Téléphone */}
      <div className="space-y-2">
        <Label htmlFor="telephone" className="text-foreground flex items-center gap-2">
      ...
      {/* Commentaire */}
      <div className="space-y-2">
        <Label htmlFor="commentaire" className="text-foreground flex items-center gap-2">
