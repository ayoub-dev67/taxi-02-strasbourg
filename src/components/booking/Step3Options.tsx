        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className={cn(
              ...
              data.typeTrajet === "aller-simple"
                ? "bg-gold-50 border-gold-400 ring-2 ring-gold-400/20"
                : "bg-surface-100 border-gold-400/20 hover:border-gold-400/50"
            )}
          >
            <div className="flex items-center gap-2 mb-2">
              <ArrowRight className="w-5 h-5 text-gold-400" />
              <span className="text-foreground font-medium">Aller simple</span>
            </div>
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-foreground font-medium">Aller-retour</span>
            </div>
            <p className="text-gray-500 text-xs">
      ...
      <div className="space-y-4">
        ...
        <div className="card-premium flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-gold-50 flex items-center justify-center shrink-0">
              <Users className="w-5 h-5 text-gold-400" />
            </div>
            <div className="min-w-0">
              <p className="text-foreground font-medium">Passagers</p>
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <button
              ...
              className={cn(
                ...
                passagers <= 1
                  ? "bg-surface-100 text-gray-600 cursor-not-allowed"
                  : "bg-gold-50 text-gold-400 hover:bg-gold-100 active:bg-gold-400/30"
              )}
              aria-label="Réduire le nombre de passagers"
            >
              <Minus className="w-5 h-5" />
            </button>
            <span className="text-foreground font-bold text-xl w-8 text-center tabular-nums">
              {passagers}
            </span>
            <button
              type="button"
        ...
        <div className="card-premium flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-foreground font-medium">Bagages</p>
        ...
        <div className="card-premium flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <p className="text-foreground font-medium">Animaux</p>
      ...
      <div className="space-y-3">
        ...
        <label className="flex items-center gap-3 p-4 rounded-lg border border-gold-400/20 hover:border-gold-400/40 transition-colors cursor-pointer">
          <Checkbox
            ...
            className="border-gold-400/30 data-[state=checked]:bg-gold-400 data-[state=checked]:border-gold-400"
          />
          <Baby className="w-5 h-5 text-gold-400" />
          <div>
            <p className="text-foreground">Siège bébé / rehausseur</p>
        ...
        <label className="flex items-center gap-3 p-4 rounded-lg border border-gold-400/20 hover:border-gold-400/40 transition-colors cursor-pointer">
          ...
          <div>
            <p className="text-foreground">Fauteuil roulant</p>
