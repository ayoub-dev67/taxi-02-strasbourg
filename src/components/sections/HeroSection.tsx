...
import { ArrowRight, Phone, Shield, Clock, Star, CheckCircle, Luggage, Route } from "lucide-react";
    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div className="absolute inset-0" style={{ y: backgroundY }}>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(10,10,10,0.2) 0%, rgba(10,10,10,0.1) 50%, rgba(10,10,10,0.4) 100%)",
          }}
        />
      ...
      <motion.div className="relative z-10 w-full px-4 py-24 sm:px-6 lg:px-8" style={{ opacity }}>
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur-sm text-gold-400 font-semibold rounded-full border border-gold-400/30 mb-6"
          >
          ...
          >
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg border-2 border-white text-white font-semibold transition-all duration-300 hover:bg-white hover:text-gold-400 active:scale-[0.98] min-h-12"
            >
