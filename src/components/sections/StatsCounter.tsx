...
function StatCard({ stat, isVisible }: { stat: Stat; isVisible: boolean }) {
  ...
  return (
    <div className="text-center">
      <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gold-50 border border-gold-400/20 flex items-center justify-center">
...
export function StatsCounter() {
  ...
  return (
    <section ref={ref} className="py-16 md:py-24 bg-gradient-to-b from-surface to-surface-50">
