...
const faqs = [
  {
    ...
    answer:
      "Réserver votre taxi n'a jamais été aussi simple ! Vous avez trois options : appelez-nous directement au 07 53 14 53 71 pour une réponse immédiate, envoyez-nous un message WhatsApp si vous préférez l'écrit, ou utilisez notre formulaire de réservation en ligne disponible 24h/24. Nous confirmons chaque réservation par SMS pour votre tranquillité d'esprit. Pour les transferts aéroport ou rendez-vous médicaux importants, nous vous conseillons de réserver au moins 24h à l'avance pour garantir votre créneau. Réservez maintenant en quelques clics !",
  },
  {
    question: "Êtes-vous conventionné par la CPAM ?",
    answer:
      "Absolument ! Taxi 02 Strasbourg est officiellement conventionné par la Sécurité Sociale depuis plusieurs années. Cela signifie que vos transports médicaux peuvent être pris en charge à 100% sur présentation d'une prescription médicale de transport (bon de transport). Nous nous occupons de TOUTES les démarches administratives avec votre CPAM : vous n'avez rien à avancer ni aucun papier à remplir. Des milliers de patients strasbourgeois nous font confiance chaque année pour leurs soins. Appelez-nous au 07 53 14 53 71 pour organiser votre prochain transport médical !",
  },
  {
