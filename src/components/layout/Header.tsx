          ...
          <div className="flex items-center justify-between">
                      ...
                      <AnimatePresence>
                        {isServicesOpen && (
                          <motion.div
                            ...
                            className="absolute top-full left-0 mt-2 w-64 bg-surface-50 border border-gold-400/20 rounded-xl shadow-dark overflow-hidden"
                          >
            ...
            <div className="hidden lg:flex items-center gap-4">
              <a
                ...
                className={cn("flex items-center gap-2 hover:text-gold-400 transition-colors", !isScrolled && isHomepage ? "text-white" : "text-foreground")}
              >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            {/* Contact rapide */}
            <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gold-400/20 pb-safe bg-surface">
