...
export function SkeletonCard({ className }: SkeletonProps) {
  return (
    <div
      className={cn(
        "rounded-2xl border border-gold-400/10 bg-surface-100 p-6",
        className
      )}
    >
...
export function SkeletonServiceCard({ className }: SkeletonProps) {
  return (
    <div
      className={cn(
        "rounded-2xl border border-gold-400/10 bg-surface-100 p-6 text-center",
        className
      )}
    >
...
export function SkeletonMap({ className }: SkeletonProps) {
  return (
    <div
      className={cn(
        "rounded-2xl border border-gold-400/20 bg-surface-100 overflow-hidden relative",
        className
      )}
    >
