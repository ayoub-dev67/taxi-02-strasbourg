  ...
  return (
    <div className="space-y-2 text-sm">
      <div className="flex items-center gap-2">
        ...
        <span className="text-gray-700">Chauffeur disponible maintenant</span>
      </div>
      <div className="flex items-center gap-2">
        <Clock className="w-4 h-4 text-gold-400" />
        <span className="text-gray-700">Réponse garantie sous 5 minutes</span>
      </div>
      <div className="flex items-center gap-2">
        <MessageSquare className="w-4 h-4 text-blue-400" />
        <span className="text-gray-700">Confirmation SMS immédiate</span>
      </div>
    </div>
  );
}
