...
const SESSION_KEY = "taxi-02-exit-popup-shown";
...
export function ExitIntentPopup() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Popup */}
      <div className="relative bg-gradient-to-br from-surface-50 to-surface border border-gold-400/40 rounded-2xl p-6 sm:p-8 max-w-md w-full animate-[scaleIn_0.3s_ease-out] shadow-gold-intense">
        {/* Close button */}
        <button
          onClick={handleClose}
        ...
        <div className="text-center">
          <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gold-50 border border-gold-100 flex items-center justify-center">
