...
export const trajets: Trajet[] = [
  {
    ...
    metaDescription: "Taxi Strasbourg Aéroport Entzheim. Prix fixe dès 25€, trajet 15 min. Suivi de vol, prise en charge 24h/24. ☎ 07 53 14 53 71",
    highlights: [
  ...
  },
  {
    ...
    metaDescription: "Taxi vers Gare de Strasbourg. Prix dès 12€, trajet rapide. TGV, TER, ICE. Réservation 24h/24. ☎ 07 53 14 53 71",
    highlights: [
  ...
  },
  {
    ...
    metaDescription: "Taxi Strasbourg EuroAirport Bâle-Mulhouse. Prix fixe dès 180€, trajet 1h30. Véhicule confortable, réservation 24h/24. ☎ 07 53 14 53 71",
    highlights: [
  ...
  },
  {
    ...
    metaDescription: "Taxi Strasbourg Europa-Park. Prix dès 90€, trajet 50 min. Siège enfant gratuit, famille bienvenue. ☎ 07 53 14 53 71",
    highlights: [
  ...
  },
  {
    ...
    metaDescription: "Taxi Strasbourg Colmar. Prix dès 110€, trajet 1h. Route des vins, tourisme. Réservation 24h/24. ☎ 07 53 14 53 71",
    highlights: [
  ...
  },
  {
    ...
    metaDescription: "Taxi Strasbourg Paris. Transfert longue distance, prix sur devis. Groupes, entreprises, horaires flexibles. ☎ 07 53 14 53 71",
    highlights: [
